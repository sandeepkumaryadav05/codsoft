...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#3f8efc";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#a9d6e5";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#a9d6e5";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#a9d6e5";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#a9d6e5";
    }
}
